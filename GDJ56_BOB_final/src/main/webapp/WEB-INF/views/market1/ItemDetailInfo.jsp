...
<section>
           ...
           <div class="tab-pane active" id="tabs-1" role="tabpanel">
               <div class="product__details__tab__desc">
                   ...
                   <div  style="text-align: center;">
                       ...
                       <img src="./img/latest-product/lp-2.jpg" alt="" style="width:500px;height: 500px;margin-left: 50px;">
                   </div>
                   <br><br><br>
               </div>
           </div>
       ...
       <div>
               <span class="col-3" style="background-color: rgb(232, 247, 242);font-weight: bold;">판매자 정보 : </span>
               <span class="col-5" style="background-color: rgb(242, 253, 250);font-weight: bold;">오늘의 밥</span>
       </div>
</section>
