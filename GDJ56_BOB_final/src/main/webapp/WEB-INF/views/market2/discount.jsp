...
<section class="bg-title-page flex-c-m p-t-160 p-b-80 ">
	<img src="./images/itemdiscountbanner.png" width="1000" id="itemdiscountbanner" />
</section>
					...
					<div class="ri-text">
						...
						<div style="display: flex; margin-top: 1%; justify-content: space-between; align-items: center;">
							<div style="display: flex;">
								...
								<h6 style="text-decoration: line-through; margin-left: 10px;">8,800</h6><h6 style="text-decoration: line-through;">원</h6>
							</div>
						</div>
