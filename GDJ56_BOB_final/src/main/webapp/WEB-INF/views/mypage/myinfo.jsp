        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div style="width: 1000px; margin: auto; display:flex;">
            	<div>
            		<p style="font-size:20px;"><b>회원정보<b></p>
            	</div>
            
            	<div style="margin-left:770px;">
                 <button onclick="passwordCh();" class="px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"> 
                   비밀변호 변경
                 </button>
            	</div>
               ...
               >
                 ...
                 <label class="block text-sm">
                   ...
                   readonly
                     ...
                     value="${m.email }"
                     name="updateEmail"
                     style="width:fit-content;background-color:lightgray;"
                   />
                 </label>
                 <br>
                 <label class="block text-sm">
