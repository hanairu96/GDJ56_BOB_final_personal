      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
             <h4
                style="text-align:center;font-size: 20px; color: purple; border: 2px solid purple; border-radius:10px; padding: 10px;"
          ...
          <div
			 id="modal_memberDelete" style="width:500px;height:auto; display: none;background-color: white;border-radius: 15px 15px;text-align: left;"
			   class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
			  <h1 style="text-align: center;"><b>정말 해당 회원을 탈퇴시키겠습니까? 복구할 수 없습니다.</b></h1>
