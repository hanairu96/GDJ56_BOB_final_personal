        ...
        <main class="h-full pb-16 overflow-y-auto" >
          ...
          <div 
            ...
            class="container px-6 mx-auto grid">
              ...
              >
             <img 
              src="${path}/resources/assets/img/cooking.JPG">
              </div>
          ...
          <div 
            ...
            <div 
              ...
              <label class="block text-sm">
                <div style="text-align:center;">
                  <span style="font-size: 15px; text-shadow:  1px 1px 1px lightgrey;" class="text-gray-700 dark:text-gray-400"><b>종료된 클래스</b></span>
                </div>
                    <!-- New Table -->
                <div style="margin-top: 15px;" class="w-full overflow-hidden rounded-lg shadow-xs">
                  <div class="w-full overflow-x-auto">
