       ...
       <ul class="mt-6">
         <li class="relative px-6 py-3">
           ...
           >
             ...
             <span class="ml-4" style="color:#707275">HOME</span>
           </a>
         </li>
       </ul>
       <ul>
         ...
         <li class="relative px-6 py-3">
          ...
          ></span>
           ...
           >
             ...
             <span class="ml-4" style="color:#1A1C23">환불관리</span>
           </a>
         </li>
         <li class="relative px-6 py-3">
           <a
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap"style="text-align:center;">
                  <thead>
                    ...
                    >
                      <th colspan="2" class="px-4 py-3">주문내역</th>
                      <th colspan=""class="px-4 py-3">관리</th>
                    </tr>
                  </thead>
                  ...
                  class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td rowspan="3" class="px-4 py-3 text-sm font-semibold" style="border-right:1px solid gray;">
                        2020/10/06<br><br>
                        <p style="color: blue;">2022121995765220</p><br>
                        적립금 사용 : 100원<br>
                      </td>
                      <td rowspan="2" style="width:500px; height:200px;border-right:1px solid gray;" class="px-4 py-3 text-sm font-semibold">
                        주문내역이 여기 뜹니당,,,,,,,
                      </td>
                      <td rowspan="2" style="border-top:1px solid gray;"class="px-4 py-3 text-sm font-semibold">
                        <button
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <!-- <td></td> -->
                      <td colspan="2" style="text-align: left;" class="px-4 py-3 text-sm font-semibold">
                        구매자 : 김땡땡<br>
                        주소 :<br>
                        연락처 :<br>
                      </td>
