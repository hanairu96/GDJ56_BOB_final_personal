  ...
  <body>
   ...
   >
     <div class="py-4 text-gray-500 dark:text-gray-400">
         ...
         <li class="relative px-6 py-3">
          ...
          ></span>
           ...
           >
             ...
             <span class="ml-4" style="color:#1A1C23">1:1 답변</span>
           </a>
         </li>
         <li class="relative px-6 py-3">
          <a
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                          ...
                          <td class="px-4 py-3 text-sm font-semibold">
                            <div class="flex items-center text-sm" style="display: flex; justify-content:center">
                              ...
                              <div style="display: flex;flex-direction: row;">
                                <p class="font-semibold" id="adminQnATitle">배송비 문의합니다!!</p>
                              </div>
                            </div>
      ...
      <!-- 모달창 -->
      <div
        id="my_modal" style="width:500px;height:auto; display: none;background-color: white;border-radius: 15px 15px;text-align: left;"
        ...
        <label class="block text-sm">
          ...
          <input
            ...
            placeholder="" value="배송비 문의합니다!!" readonly
          />
        </label>
        <br>
            <label class="block text-sm">
              ...
              <input
                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                placeholder="" value="질문쟁이" readonly
              />
            </label>
            <br>
          <label class="block mt-4 text-sm">
            ...
            <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="" value="배송비 무료 기준이 무엇인가요?" readonly
                />
          </label>
          <br>
          <label class="block mt-4 text-sm">
    ...
    document.getElementById('adminQnATitle').addEventListener('click', function() {
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                          <td class="px-4 py-3 text-sm font-semibold">
                            <div class="flex items-center text-sm" style="display: flex; justify-content:center">
                              ...
                              <div style="display: flex;flex-direction: row;">
                                <p class="font-semibold" id="adminQnATitle">적립금 문의ㅠㅠ</p>
                              </div>
                            </div>
