...
<c:set var="path" value="${pageContext.request.contextPath}"/>
				...
				<div class="rowss">
					...
					<div>
						<div>
							...
							<div class="sns">
								<img id="kakaotalk" src="${path}/resources/images/kakaotalk.png" onclick="sendKakao();">
								<img id="facebook" src="${path}/resources/images/facebook.png" onclick="sendFacebook();">
								<img id="twitter" src="${path}/resources/images/twitter.png" onclick="sendTwitter();">
							</div>
						</div>
					</div>
				</div>
	...
	<!-- Footer Section End -->
		...
		<script>
			...
			//페이스북 공유하기
			const sendFacebook=()=>{
				let url="http://www.facebook.com/sharer/sharer.php?u="+encodeURIComponent(document.URL);
				window.open(url, "_blank", "width=500, height=600");
			}
			
			//트위터 공유하기
			const sendTwitter=()=>{
				let url="http://twitter.com/share?url="+encodeURIComponent(document.URL)+"&text="+encodeURIComponent('오늘의 밥');
				window.open(url, "_blank", "width=500, height=600");
			}
		</script>
	</div>
