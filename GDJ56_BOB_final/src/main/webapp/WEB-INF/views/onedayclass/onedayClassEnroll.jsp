		...
		<div>
			...
			<form class="size22 m-l-r-auto" action="${path}/class/EndclassEnroll.do" method="post" enctype="multipart/form-data">
				...
				<div style="display: flex;">
					<div class="size12 bo2 bo-rad-10 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="date" name="startDate" id="startDate" onchange="settleDate1()" required>
					</div>
					<h2> &nbsp;~&nbsp; </h2>
					<div class="size12 bo2 bo-rad-10 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="date" id="endDate" name="endDate" onchange="settleDate2()" required>
					</div>
				...
				<div id="classaddress" style="margin-bottom: 3%; border:solid gray 1px; border-radius: 10px; padding: 2%;">
					<div class=" bo-rad-10" style="display: flex; margin-bottom: 1%;">
						<input  type="text" id="sample6_postcode" placeholder="우편번호" style="border-bottom:solid black 1px;" readonly>
						<button type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">우편번호찾기</button>
					</div>
						
						<input type="text" id="sample6_address" style="border-bottom:solid black 1px; width: 100% ;" placeholder="도로명주소" name="address" required>
						<span>─────────────────────────────────────</span>
						<input  type="text" id="sample6_detailAddress" style="border-bottom:solid black 1px; width: 100%;" placeholder="상세주소를 입력해주세요" name="address" required>
						<span>─────────────────────────────────────</span>
				</div>
				...
				<div class="size12 bo2 bo-rad-10 m-b-23" style="display: flex;">
					<input class="bo-rad-10 sizefull txt10 p-l-20" type="number" name="odcPrice" placeholder="금액에 해당하는 숫자값만 입력해주세요" required> 
					<h4>원</h4>
				</div>
				...
				<div style="display: flex;">
					...
					<div style="margin-bottom: 3%; border:solid gray 1px; border-radius: 10px; padding: 2%; display: inline-flex">
						<div style="margin-left:10%; margin-right:10%; width:100%" >
							<div style="margin:3%;">
							<img id="preview" alt="" width="350" height="200" >
							</div>
							<ul>
								<li><input type="file" onchange="readURL(this);" name="odcpic" value="${odc.odcMainPic}" required></li>
							</ul>
						</div>
					</div>
				</div>
