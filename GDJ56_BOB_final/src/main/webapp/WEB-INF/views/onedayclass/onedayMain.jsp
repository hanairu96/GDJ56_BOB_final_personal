...
<body>
	<section>
		...
		<div style="padding-left: 46%; margin-right: 3%; padding-top: 5%;">
				<button class="menu txt26 trans-0-4">
					전체
				</button>
		...
		<!-- 검색창 -->
		<div id="searchbox" >
			<select name='searchlist' style="padding: 0.3%; margin: 1%;">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4" style="padding: 3%;">
					<div class="zoom">
						<a href=""><img src="${path}/resources/pato/images/class/kimchi.jpg" alt="" width="350" height="300"></a>
					</div>
						
					<div class="category-name" >집밥</div>

					<a href=""><b><h4>묵은지 김치찜</h4></b></a>

					<div style="display: flex; margin-top: 1%;">
						<img src="${path}/resources/pato/images/class/chef-hat.png" width="20" height="20"><h5>김강사</h5>
						&nbsp;&nbsp;&nbsp;<img src="${path}/resources/pato/images/class/place-marker.png" width="20" height="20" ><h5>서울시 성동구</h5>
					</div>			
				</div>
