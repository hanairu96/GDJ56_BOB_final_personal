...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('제주특별자치도 서귀포시 김정문화로27번길 13-3 101동 101호', function(result, status) {
    ...
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: '<div style="width:150px;text-align:center;padding:6px 0;">원데이클래스 수업 장소</div>'
        });
