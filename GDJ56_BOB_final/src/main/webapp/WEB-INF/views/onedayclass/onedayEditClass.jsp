		...
		<div>
			...
			<form class="size22 m-l-r-auto" action="${path}/class/EndclassEnroll.do" method="post" enctype="multipart/form-data">
				...
				<div class="size12 bo2 bo-rad-10 m-b-23">
					...
					<input type="text" name="odcNo" value="${odc.odcNo}">
				...
				<div style="display: flex;">
					<div class="size12 bo2 bo-rad-10 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="date" name="startDate" value="${startDate}">
						<c:set var="minDate" value="${startDate}"/>
					</div>
					<h2> &nbsp;~&nbsp; </h2>
					<div class="size12 bo2 bo-rad-10 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="date" name="endDate" value="${endDate}">
					</div>
				</div>
				...
				<div class="size12 bo2 bo-rad-10 m-b-23">
					<input class="bo-rad-10 sizefull txt10 p-l-20" type="time" name="odcStartTime" value="${odc.odcStartTime }">
				</div>
				...
				<div class="size12 bo2 bo-rad-10 m-b-23">
					<input class="bo-rad-10 sizefull txt10 p-l-20" type="number" name="odcTime" min="1" value="${odc.odcTime }">
				</div>
				...
				<div style="margin-bottom:3%;">
					...
					<input class="" type="file" name="odcpic" value="${odc.odcMainPic }"> 
				</div>
