...
public class oneclass {
	public static String getPage(int cPage,int numPerpage, int totalData,String url,String searchlist, String search ) {
		String pageBar="";
...
//      </div>
		...
		pageBar+="location.assign('"+url+"?cPage='+pageNo+'&search="+search+"&searchlist="+searchlist+"');";
		pageBar+="}";
		pageBar+="</script>";
